...
export class FreshMigration1751035267562 implements MigrationInterface {
    name = 'FreshMigration1751035267562'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "appointments" ("appointment_id" SERIAL NOT NULL, "appointment_status" "public"."appointments_appointment_status_enum" NOT NULL DEFAULT 'scheduled', "reason" character varying, "notes" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "doctor_id" integer, "patient_id" integer, "time_slot_id" integer, CONSTRAINT "UQ_fb92c47131d1e8896b06fd6c1b9" UNIQUE ("patient_id", "time_slot_id"), CONSTRAINT "PK_dde485d1b7ca51845c075befb6b" PRIMARY KEY ("appointment_id"))`);
