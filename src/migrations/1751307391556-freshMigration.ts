...
export class FreshMigration1751307391556 implements MigrationInterface {
  name = 'FreshMigration1751307391556';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "doctor_time_slots" ("timeslot_id" SERIAL NOT NULL, "date" date NOT NULL, "startTime" TIME NOT NULL, "endTime" TIME NOT NULL, "status" "public"."doctor_time_slots_status_enum" NOT NULL DEFAULT 'available', "maxPatients" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "doctor_id" integer, "availability_id" integer, CONSTRAINT "PK_8ae12dfe3687c8c338b5f24f4cf" PRIMARY KEY ("timeslot_id"))`,
    );
    await queryRunner.query(
